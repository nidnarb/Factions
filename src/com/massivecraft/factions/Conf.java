...
public class Conf
{
	...
	public static Map<FFlag, Boolean> guildFlagDefaults;
	public static Map<FFlag, Boolean> guildFlagIsChangeable;
	public static Map<FPerm, Set<Rel>> guildPermDefaults;
	...
	public static double powerguildMax = 0.0;  // if greater than 0, the cap on how much power a guild can have (additional power from players beyond that will act as a "buffer" of sorts)
	
	public static String prefixLeader = "**";
	public static String prefixOfficer = "*";
	
	public static int guildTagLengthMin = 3;
	public static int guildTagLengthMax = 10;
	public static boolean guildTagForceUpperCase = false;
	
	public static boolean newguildsDefaultOpen = false;

	// when guild membership hits this limit, players will no longer be able to join using /f join; default is 0, no limit
	public static int guildMemberLimit = 0;

	// what guild ID to start new players in when they first join the server; default is 0, "no guild"
	public static String newPlayerStartingguildID = "0";

	//public static boolean showMapguildKey = true;
	//public static boolean showNeutralguildsOnMap = true;
	//public static boolean showEnemyguildsOnMap = true;
	
	// Disallow joining/leaving/kicking while power is negative
	public static boolean canLeaveWithNegativePower = true;
	
	// Configuration on the guild tag in chat messages.
	public static boolean chatSetFormat = false;
	public static String chatSetFormatTo = "<{guild_relcolor}§l{guild_roleprefix}§r{guild_relcolor}{guild_tag_pr}"+ChatColor.WHITE.toString()+"%s> %s";
	...
	// Herochat
	public static String herochatguildChannelName = "guild";
	...
	public static boolean logguildCreate = true;
	public static boolean logguildDisband = true;
	public static boolean logguildJoin = true;
	public static boolean logguildKick = true;
	public static boolean logguildLeave = true;
	...
	public static boolean disablePVPForguildlessPlayers = false;
	public static boolean enablePVPAgainstguildlessInAttackersLand = false;
	
	public static int noPVPDamageToOthersForXSecondsAfterLogin = 3;

	//public static boolean peacefulMembersDisablePowerLoss = true;
	
	public static boolean permanentguildsDisableLeaderPromotion = false;
	
	public static boolean claimsMustBeConnected = false;
	public static boolean claimsCanBeUnconnectedIfOwnedByOtherguild = true;
	public static int claimsRequireMinguildMembers = 1;
	public static int claimedLandsMax = 0;

	// if someone is doing a radius claim and the process fails to claim land this many times in a row, it will exit
	public static int radiusClaimFailureLimit = 9;

	//public static double considerguildsReallyOfflineAfterXMinutes = 0.0;
	
	public static int actionDeniedPainAmount = 2;

	// commands which will be prevented if the player is a member of a permanent guild
	public static Set<String> permanentguildMemberDenyCommands = new LinkedHashSet<String>();

	// commands which will be prevented when in claimed territory of another guild
	...
	// for claimed areas where further guild-member ownership can be defined
	...
	// Spout features
	public static boolean spoutguildTagsOverNames = true;  // show guild tags over names over player heads
	public static boolean spoutguildTitlesOverNames = true;  // whether to include player's title in that
	...
	public static boolean spoutCapes = true;  // Show guild capes
	...
	public static boolean spoutTerritoryDisplayShowDescription = true;  // whether to show the guild description, not just the guild tag
	...
	public static boolean spoutTerritoryNoticeShowDescription = false;  // whether to show the guild description in the notice, not just the guild tag
	...
	public static double econCostClaimFromguildBonus = 30.0;
	...
	//guild banks, to pay for land claiming and other costs instead of individuals paying for them
	public static boolean bankEnabled = true;
	//public static boolean bankMembersCanWithdraw = false; //Have to be at least moderator to withdraw or pay money to another guild
	public static boolean bankguildPaysCosts = true; //The guild pays for guild command costs, such as sethome
	public static boolean bankguildPaysLandCosts = true; //The guild pays for land claiming costs.
	...
	// TODO: A better solution Would be to have One wilderness guild per world.
	...
	static
	{
		...
		guildFlagDefaults = new LinkedHashMap<FFlag, Boolean>();
		for (FFlag flag : FFlag.values())
		{
			guildFlagDefaults.put(flag, flag.defaultDefaultValue);
		}
		
		guildPermDefaults = new LinkedHashMap<FPerm, Set<Rel>>();
		for (FPerm perm: FPerm.values())
		{
			guildPermDefaults.put(perm, perm.defaultDefaultValue);
		}
