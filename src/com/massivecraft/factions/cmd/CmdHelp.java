...
public class CmdHelp extends FCommand
{
	...
	public void perform()
	{
		...
		sendMessage(p.txt.titleize("Nommix Guild Help ("+page+"/"+helpPages.size()+")"));
	...
	public void updateHelp()
	{
		...
		pageLines.add( p.txt.parse("<i>Learn how to create a guild on the next page.") );
		...
		{
			pageLines = new ArrayList<String>();
			pageLines.add( p.txt.parse("<i>Your Guild has a bank which is used to pay for certain" ));
		...
		pageLines.add( p.txt.parse("<i>Player titles are just for fun. Use your creativity" ));
		helpPages.add(pageLines);
		...
		pageLines.add(p.txt.parse("<i>that only the guild masters, guild admin, and possibly the"));
		pageLines.add(p.txt.parse("<i>guild moderators have full access."));
		helpPages.add(pageLines);
		...
		pageLines.add(p.txt.parse("<i>Set the relation you WISH to have with another guild."));
		pageLines.add(p.txt.parse("<i>Your default relation with other guilds will be neutral."));
		pageLines.add(p.txt.parse("<i>If BOTH guilds choose \"ally\" you will be allies."));
		pageLines.add(p.txt.parse("<i>If ONE guild chooses \"enemy\" you will be enemies."));
		helpPages.add(pageLines);
		...
		pageLines.add(p.txt.parse("<i>You can always hurt enemies and players without a guild."));
		pageLines.add("");
		...
		pageLines.add(p.txt.parse("<i>The power of a guild is the sum of all member power."));
		pageLines.add(p.txt.parse("<i>The power of a guild determines how much land it can hold."));
		pageLines.add(p.txt.parse("<i>You can claim land from guilds with too little power."));
		helpPages.add(pageLines);
		
		pageLines = new ArrayList<String>();
		pageLines.add(p.txt.parse("<i>Only guild members can build and destroy in their own"));
		...
		pageLines = new ArrayList<String>();
		pageLines.add("Some Commands for our admins:");
